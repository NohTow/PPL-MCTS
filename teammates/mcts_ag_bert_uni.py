...
logging.basicConfig(
    ...
    filename=("log/ag_news/mcts_{}_{}_{}_{}_bert_uni.log".format(args.c, args.temperature, args.penalty, args.num_it))
)
...
classi_config = BertConfig.from_pretrained("bert_uni_agnews", **config_kwargs)
classi = Net.from_pretrained("bert_uni_agnews", config=classi_config)
classi.cuda()
classi.eval()
...
class NumpyMCTS():
    ...
    def create_node(self, node_index, prior, likelihoods, values, original_states, original_tokens_ids, original_attention_masks, classi_states, expanded_node_is_terminal):
