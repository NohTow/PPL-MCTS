...
logging.basicConfig(
    ...
    filename=("../log/CLS/mcts_{}_{}_{}_{}_{}_testgit.log".format(args.c, args.temperature, args.penalty, args.num_it, args.rollout_size))
)
...
# Padding left because GPT-2 is auto regressive, see: https://discuss.huggingface.co/t/batch-generation-with-gpt2/1517/2
